...
package com.android.mmms.service_alt;
...
import com.android.mmms.service_alt.exception.MmsHttpException;
...
import com.klinker.android.send.Transaction;
...
//                downloadCallback);
    ...
    private String getContentLocation(Context context, Uri uri)
            throws MmsException {
        Cursor cursor = androids.database.sqlite.SqliteWrapper.query(context, context.getContentResolver(),
    ...
    private static Long getId(Context context, String location) {
        ...
        Cursor c = androids.database.sqlite.SqliteWrapper.query(
    ...
    private static void setErrorType(Context context, String locationUrl, int errorType) {
        ...
        try {
            if ((cursor.getCount() == 1) && cursor.moveToFirst()) {
                ...
                androids.database.sqlite.SqliteWrapper.update(context, context.getContentResolver(),
