...
import com.google.android.mmms.pdu_alt.SendConf;
    ...
    public void run() {
        ...
        try {
            ...
            if (mTransactionState.getState() != TransactionState.SUCCESS) {
                ...
                Intent intent = new Intent(com.klinker.android.send.Transaction.MMS_ERROR);
                intent.putExtra("stack", builder.toString());
                BroadcastUtils.sendExplicitBroadcast(
                        mContext, intent, com.klinker.android.send.Transaction.MMS_ERROR);
            }
            notifyObservers();
        }
    }
