...
package com.android.mmms.transaction;
...
import com.android.mmms.logs.LogTag;
import com.android.mmms.MmsConfig;
import com.android.mmms.util.DownloadManager;
...
import static com.android.mmms.transaction.TransactionState.FAILED;
import static com.android.mmms.transaction.TransactionState.INITIALIZED;
import static com.android.mmms.transaction.TransactionState.SUCCESS;
import static com.google.android.mmms.pdu_alt.PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF;
import static com.google.android.mmms.pdu_alt.PduHeaders.STATUS_DEFERRED;
import static com.google.android.mmms.pdu_alt.PduHeaders.STATUS_RETRIEVED;
import static com.google.android.mmms.pdu_alt.PduHeaders.STATUS_UNRECOGNIZED;
...
public class NotificationTransaction extends Transaction implements Runnable {
    ...
    public NotificationTransaction(
        ...
        try {
            ...
            try {
                group = com.klinker.android.send.Transaction.settings.getGroup();
            } catch (Exception e) {
            ...
            if (retrieveConfData != null) {
                ...
                if ((pdu == null) || (pdu.getMessageType() != MESSAGE_TYPE_RETRIEVE_CONF)) {
                    ...
                    Uri uri = p.persist(pdu, Inbox.CONTENT_URI, true,
                            com.klinker.android.send.Transaction.settings.getGroup(), null);
                    ...
                    BroadcastUtils.sendExplicitBroadcast(
                            mContext,
                            new Intent(),
                            com.klinker.android.send.Transaction.NOTIFY_OF_MMS);
                }
            }
