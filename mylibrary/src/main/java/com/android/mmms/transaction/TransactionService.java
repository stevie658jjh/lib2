                ...
                try {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                            ...
                            if (com.klinker.android.send.Transaction.settings != null) {
                                useSystem = com.klinker.android.send.Transaction.settings
                                        .getUseSystemSending();
                            } else {
                            ...
                            if (useSystem) {
                                try {
                                    ...
                                    com.android.mmms.transaction.DownloadManager.getInstance().
                ...
                if (mmsNetworkInfo.isConnected()) {
                    ...
                    if (TextUtils.isEmpty(settings.getMmscUrl())) {
                        ...
                        BroadcastUtils.sendExplicitBroadcast(
                                ...
                                new Intent(),
                                com.klinker.android.send.Transaction.MMS_ERROR);
