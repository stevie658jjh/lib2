...
public class LinkProperties implements Parcelable {
    ...
    String mIfaceName;
    private Collection<androids.net.LinkAddress> mLinkAddresses = new ArrayList<androids.net.LinkAddress>();
    private Collection<InetAddress> mDnses = new ArrayList<InetAddress>();
    private Collection<androids.net.RouteInfo> mRoutes = new ArrayList<androids.net.RouteInfo>();
    ...
    public LinkProperties(LinkProperties source) {
        if (source != null) {
            ...
            for (androids.net.LinkAddress l : source.getLinkAddresses()) mLinkAddresses.add(l);
            for (InetAddress i : source.getDnses()) mDnses.add(i);
            for (androids.net.RouteInfo r : source.getRoutes()) mRoutes.add(r);
    ...
    public Collection<InetAddress> getAddresses() {
        ...
        for (androids.net.LinkAddress linkAddress : mLinkAddresses) {
            addresses.add(linkAddress.getAddress());
        }
        return Collections.unmodifiableCollection(addresses);
    }

    public void addLinkAddress(androids.net.LinkAddress address) {
        if (address != null) mLinkAddresses.add(address);
    }

    public Collection<androids.net.LinkAddress> getLinkAddresses() {
    ...
    public void addRoute(androids.net.RouteInfo route) {
        if (route != null) mRoutes.add(route);
    }

    public Collection<androids.net.RouteInfo> getRoutes() {
    ...
    public String toString() {
        ...
        for (androids.net.LinkAddress addr : mLinkAddresses) linkAddresses += addr.toString() + ",";
        linkAddresses += "] ";
        ...
        for (androids.net.RouteInfo route : mRoutes) routes += route.toString() + ",";
        routes += "] ";
    ...
    public boolean isIdenticalRoutes(LinkProperties target) {
        Collection<androids.net.RouteInfo> targetRoutes = target.getRoutes();
     ...
     */
    public CompareResult<androids.net.LinkAddress> compareAddresses(LinkProperties target) {
        /*
         ...
         * addedAddresses.
         */
        CompareResult<androids.net.LinkAddress> result = new CompareResult<androids.net.LinkAddress>();
        result.removed = new ArrayList<androids.net.LinkAddress>(mLinkAddresses);
        result.added.clear();
        if (target != null) {
            for (androids.net.LinkAddress newAddress : target.getLinkAddresses()) {
     ...
     * @return the removed and added lists.
     */
    public CompareResult<androids.net.RouteInfo> compareRoutes(LinkProperties target) {
        /*
         ...
         */
        CompareResult<androids.net.RouteInfo> result = new CompareResult<androids.net.RouteInfo>();

        result.removed = new ArrayList<androids.net.RouteInfo>(mRoutes);
        result.added.clear();
        if (target != null) {
            for (androids.net.RouteInfo r : target.getRoutes()) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        for (androids.net.RouteInfo route : mRoutes) {
