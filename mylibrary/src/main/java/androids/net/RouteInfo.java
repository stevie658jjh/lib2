...
public class RouteInfo implements Parcelable {
     ...
     */
    private final androids.net.LinkAddress mDestination;
    ...
    public RouteInfo(androids.net.LinkAddress destination, InetAddress gateway) {
        if (destination == null) {
            if (gateway != null) {
                if (gateway instanceof Inet4Address) {
                    try {
                        destination = new androids.net.LinkAddress(Inet4Address.getLocalHost(), 0);
                    ...
                    try {
                        destination = new androids.net.LinkAddress(Inet6Address.getLocalHost(), 0);
                    } catch (UnknownHostException e) {
                        // TODO Auto-generated catch block
                        Log.e(TAG, "exception thrown", e);
                    }
        ...
        mDestination = new androids.net.LinkAddress(NetworkUtilsHelper.getNetworkPart(destination.getAddress(),
    ...
    public static RouteInfo makeHostRoute(InetAddress host, InetAddress gateway) {
        ...
        if (host instanceof Inet4Address) {
            return new RouteInfo(new androids.net.LinkAddress(host, 32), gateway);
        } else {
            return new RouteInfo(new androids.net.LinkAddress(host, 128), gateway);
        }
    }
    ...
    public androids.net.LinkAddress getDestination() {
        return mDestination;
    }
    ...
    public static final Creator<RouteInfo> CREATOR =
            new Creator<RouteInfo>() {
                public RouteInfo createFromParcel(Parcel in) {
                    ...
                    androids.net.LinkAddress dest = null;
