...
public class DhcpInfoInternal {
    ...
    private Collection<androids.net.RouteInfo> mRoutes;

    public DhcpInfoInternal() {
        mRoutes = new ArrayList<androids.net.RouteInfo>();
    }

    public void addRoute(androids.net.RouteInfo routeInfo) {
    ...
    public androids.net.LinkAddress makeLinkAddress() {
    ...
    public androids.net.LinkProperties makeLinkProperties() {
        androids.net.LinkProperties p = new LinkProperties();
    ...
    public void updateFromDhcpRequest(DhcpInfoInternal orig) {
        ...
        if (mRoutes.size() == 0) {
            for (androids.net.RouteInfo route : orig.getRoutes()) {
                addRoute(route);
            }
        }
    }
